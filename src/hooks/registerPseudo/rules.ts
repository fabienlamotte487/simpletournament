import { ANTI_REGEX_PSEUDO, EMPTY_ERROR_MESSAGE, INVALID_ERROR_MESSAGE, MAX_LENGTH_PSEUDO, MIN_LENGTH_PSEUDO, REGEX_CHAR_PSEUDO, REGEX_PSEUDO, TOO_LONG_ERROR_MESSAGE, TOO_SHORT_ERROR_MESSAGE } from "./config";
